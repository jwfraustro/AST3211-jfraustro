...
class Ui_SimMainWindow(object):
    def setupUi(self, SimMainWindow):
        ...
        self.lv_bodies.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.lv_bodies.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.lv_bodies.setEditTriggers(QtWidgets.QAbstractItemView.DoubleClicked)
        ...
        self.TAB_XY_3D = QtWidgets.QWidget()
        self.TAB_XY_3D.setObjectName("TAB_XY_3D")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.TAB_XY_3D)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.graph_3D_2 = QtWidgets.QWidget(self.TAB_XY_3D)
        self.graph_3D_2.setStyleSheet("background-color: rgb(58, 58, 58);")
        self.graph_3D_2.setObjectName("graph_3D_2")
        self.horizontalLayout_3.addWidget(self.graph_3D_2)
        self.graph_xy_2 = QtWidgets.QWidget(self.TAB_XY_3D)
        self.graph_xy_2.setAutoFillBackground(False)
        self.graph_xy_2.setStyleSheet("background-color: rgb(58, 58, 58);")
        self.graph_xy_2.setObjectName("graph_xy_2")
        self.horizontalLayout_3.addWidget(self.graph_xy_2)
        self.WIDGET_LH.raise_()
        self.graph_xy_2.raise_()
        self.graph_3D_2.raise_()
        self.WIDGET_viewTabs.addTab(self.TAB_XY_3D, "")
        ...
        self.graph_xy = QtWidgets.QWidget(self.TAB_XY)
        self.graph_xy.setAutoFillBackground(False)
        self.graph_xy.setStyleSheet("background-color: rgb(58, 58, 58);")
        self.graph_xy.setObjectName("graph_xy")
        self.verticalLayout_5.addWidget(self.graph_xy)
        ...
        self.graph_3d = QtWidgets.QWidget(self.TAB_3D)
        self.graph_3d.setAutoFillBackground(False)
        self.graph_3d.setStyleSheet("background-color: rgb(58, 58, 58);")
        self.graph_3d.setObjectName("graph_3d")
        self.verticalLayout_4.addWidget(self.graph_3d)
    ...
    def retranslateUi(self, SimMainWindow):
        ...
        self.WIDGET_viewTabs.setTabText(self.WIDGET_viewTabs.indexOf(self.TAB_XY_3D), _translate("SimMainWindow", "XY / 3D Views"))
