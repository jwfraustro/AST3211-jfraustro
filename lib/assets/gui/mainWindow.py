...
class Ui_SimMainWindow(object):
    def setupUi(self, SimMainWindow):
        ...
        self.lbl_inc_reporting = QtWidgets.QLabel(self.TAB_options)
        self.lbl_inc_reporting.setObjectName("lbl_inc_reporting")
        self.gridLayout.addWidget(self.lbl_inc_reporting, 1, 0, 1, 1)
        self.rb_inc_report = QtWidgets.QRadioButton(self.TAB_options)
        self.rb_inc_report.setText("")
        self.rb_inc_report.setObjectName("rb_inc_report")
        self.gridLayout.addWidget(self.rb_inc_report, 1, 1, 1, 1)
    ...
    def retranslateUi(self, SimMainWindow):
        ...
        self.lbl_inc_reporting.setText(_translate("SimMainWindow", "Incremental Reporting:"))
