...
class Ui_SimMainWindow(object):
    def setupUi(self, SimMainWindow):
        ...
        self.frame_6 = QtWidgets.QFrame(self.TAB_bodies)
        ...
        self.le_n = QtWidgets.QLineEdit(self.frame_6)
        self.le_n.setObjectName("le_n")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.le_n)
        self.le_s = QtWidgets.QLineEdit(self.frame_6)
        self.le_s.setObjectName("le_s")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.le_s)
        self.le_r = QtWidgets.QLineEdit(self.frame_6)
        self.le_r.setObjectName("le_r")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.le_r)
    ...
    def retranslateUi(self, SimMainWindow):
        ...
        self.label.setText(_translate("SimMainWindow", "N-Steps"))
        self.label_2.setText(_translate("SimMainWindow", "Skip Steps"))
        self.label_3.setText(_translate("SimMainWindow", "Report Steps"))
