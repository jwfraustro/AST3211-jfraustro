...
class Ui_SimMainWindow(object):
    def setupUi(self, SimMainWindow):
        ...
        self.gridLayout.addWidget(self.cmb_solvetime, 6, 1, 1, 1)
        self.lbl_solvetime = QtWidgets.QLabel(self.TAB_options)
        self.lbl_solvetime.setObjectName("lbl_solvetime")
        self.gridLayout.addWidget(self.lbl_solvetime, 6, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.lbl_simdur, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.le_stepvalue, 3, 0, 1, 1)
        ...
        self.cmb_tsteps.addItem("")
        self.cmb_tsteps.addItem("")
        self.gridLayout.addWidget(self.cmb_tsteps, 3, 1, 1, 1)
        self.le_nsteps = QtWidgets.QLineEdit(self.TAB_options)
        self.le_nsteps.setObjectName("le_nsteps")
        self.gridLayout.addWidget(self.le_nsteps, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lbl_stepfreq, 5, 0, 1, 1)
        self.le_stepfreq = QtWidgets.QLineEdit(self.TAB_options)
        self.le_stepfreq.setObjectName("le_stepfreq")
        self.gridLayout.addWidget(self.le_stepfreq, 5, 1, 1, 1)
    ...
    def retranslateUi(self, SimMainWindow):
        ...
        self.le_stepfreq.setText(_translate("SimMainWindow", "10"))
